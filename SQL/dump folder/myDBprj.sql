...
--
-- Temporary table structure for view `full_beta`
--

DROP TABLE IF EXISTS `full_beta`;
/*!50001 DROP VIEW IF EXISTS `full_beta`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `full_beta` (
  `report_date` date,
  `item_id` int(10) unsigned,
  `sum(report_quantity)` decimal(32,0)
) ENGINE=MyISAM */;
...
--
-- Final view structure for view `full_beta`
--

/*!50001 DROP TABLE IF EXISTS `full_beta`*/;
/*!50001 DROP VIEW IF EXISTS `full_beta`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `full_beta` AS select `reports_list`.`report_date` AS `report_date`,`reports`.`item_id` AS `item_id`,sum(`reports`.`report_quantity`) AS `sum(report_quantity)` from (`reports_list` join `reports` on(((`reports`.`report_id` = `reports_list`.`report_id`) and (`reports`.`workshop_id` = `reports_list`.`workshop_id`)))) group by `reports`.`item_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2012-06-29 16:11:47
